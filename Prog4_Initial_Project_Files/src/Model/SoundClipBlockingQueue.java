...
public class SoundClipBlockingQueue {
	...
	// Add a Model.SoundClip to the queue, and notify all
	...
	// Remove a Model.SoundClip from the queue.
	// If the queue is empty, the invoking thread will wait until
	// there is a Model.SoundClip in the queue, and then remove it from
	// the queue.
